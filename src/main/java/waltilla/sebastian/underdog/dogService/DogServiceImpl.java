...
public class DogServiceImpl implements DogService {
    ...
    @Override
    public Dog updateDog(String idAsUUidDog, DogRequest request) {
        var id = DogValidator.validateUuid(idAsUUidDog);
        var validatedRequest = validateDogRequest(request);
        var dog = new Dog(id, validatedRequest.getBirthDate(), validatedRequest.getBreed(), validatedRequest.getName());
        return repository.updateDog(dog);
    }
